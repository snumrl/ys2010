...
#    profileDataFile = 'profile_%s.dat'%datetime.today().strftime('%y%m%d_%H%M%S')
#    profile.run('skinMesh.update(jointMotions[0][frame])', profileDataFile)
#    os.system('python ../UI/pprofui.py %s'%profileDataFile)
