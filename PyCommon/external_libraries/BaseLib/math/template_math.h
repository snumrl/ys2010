...
///////////////////////////////////////////////
//
//  T의 어레이. T는 virtual 함수를 하나도 갖고 있지 않아야 함. ex) int, m_real, quater, vector3 ...
//  vector3는 m_real 이 3개 있는것. 따라서 vector3N은 _tvectorn<vector3, m_real, 3> 을 상속하여 구현된다.
...
protected:
	...
	matViewType _column() const
	{
		...
		matViewType c(ptr, size(), T_N, stride);//sizeof(m_real));	
		return c;
	}
