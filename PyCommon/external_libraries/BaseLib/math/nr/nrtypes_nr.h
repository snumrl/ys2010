...
// NRVec<int> 와 intvectorn은 interface가 달라서 사용 못함.
class intvectorn;

typedef const intvectorn Vec_I_INT;
typedef intvectorn Vec_INT, Vec_O_INT, Vec_IO_INT;
...
class vectorn;
class vectorn;
typedef const vectorn Vec_I_DP;
typedef vectorn Vec_DP;
typedef vectorn Vec_O_DP, Vec_IO_DP;
...
class matrixn;
class matrixn;
typedef const matrixn Mat_I_DP;
typedef matrixn Mat_DP;
typedef matrixn Mat_O_DP, Mat_IO_DP;
