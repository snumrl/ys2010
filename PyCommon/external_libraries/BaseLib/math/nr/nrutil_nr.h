...
public:
	...
	inline const T* operator[](const int i) const;
	inline T& operator()(const int i, const int j)		{ return (*this)[i][j];}	//subscripting: pointer to row i
	inline const T& operator()(const int i, const int j) const { return (*this)[i][j];}	
...
public:
	...
	inline T& operator()(const int i, const int j, const int k)		{ return (*this)[i][j][k];}	//subscripting: pointer to row i
	inline const T& operator()(const int i, const int j, const int k) const{ return (*this)[i][j][k];}
