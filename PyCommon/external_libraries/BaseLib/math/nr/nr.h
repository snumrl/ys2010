...
void mnewt(const int ntrial, Vec_IO_DP &x, const DP tolx, const DP tolf, void (*usrfun)(Vec_I_DP &x, Vec_O_DP &fvec, Mat_O_DP &fjac));
...
int sprsin(Mat_I_DP &a, const DP thresh, Vec_O_DP &sa, Vec_O_INT &ija);
