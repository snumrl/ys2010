...
.PHONY: Release
Release: create_folders tmp/Win32/gccRelease/main.o 
	g++ tmp/Win32/gccRelease/main.o  $(Release_Library_Path) $(Release_Libraries) -Wl,-rpath,./ -o ../exe/Win32/gccRelease/stacking.exe
