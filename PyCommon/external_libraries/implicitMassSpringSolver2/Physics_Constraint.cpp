...
Physics_Constraint::Physics_Constraint( int iParticle, int iDegreesOfFreedom, Physics_Vector3 axis1, Physics_Vector3 axis2, Physics_Vector3 ConstrainedVelocity)
{
